...
bool TypeStringRecord::GetState( TypeStateReader& state )
{
    //
...
bool TypeStringRecord::SetState( TypeStateWriter& state, TypeStruct* )
{
    //
...
QWidget* TypeStringRecord::PropertyWidget( TypeController& controller )
{
    ...
    //
    // This property selects Stringean value:
...
void TypeStringRecord::Html( TypeHtmlBlockStream& block_stream )
{
    //
...
void TypeStringRecord::Script( TypeHtmlBlockStream& block_stream )
{
    //
    // Generate a script:
